var AppTest = (function () {
    ...
    AppTest.prototype.update = function () {
        if (this.init) {
    ...
    AppTest.prototype.onPlayerCollideWithMonster = function (player, monster) {
    ...
    AppTest.prototype.create = function () {
    ...
    AppTest.prototype.addPlayer = function () {
    ...
    AppTest.prototype.addMonsters = function (map) {
        var monster;
    ...
    AppTest.prototype.preload = function () {
